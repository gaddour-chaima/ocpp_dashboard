...
import { useEnergyDaily, useEnergyMonthly, useSessionsDaily,
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {statsLoading ? (
          ...
          <>
            <StatCard title={t.dashboard.totalEnergy} value={formatEnergy(stats?.totalEnergy)} icon={<Zap size={18} />} variant="blue" />
            <StatCard title={t.dashboard.avgPerSession} value={formatEnergy(stats?.avgEnergyPerSession)} icon={<TrendingUp size={18} />} variant="emerald" />
            <StatCard title={t.analytics.totalSessions} value={stats?.totalTransactions ?? '—'} icon={<BarChart3 size={18} />} variant="amber" />
            <StatCard title={t.analytics.onlineChargers} value={stats?.onlineChargePoints ?? '—'} icon={<Wifi size={18} />} variant="default" />
          </>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <ChartCard title={t.dashboard.dailyEnergy} subtitle={t.analytics.dailyEnergySub}>
        ...
        <ChartCard title={t.dashboard.monthlyEnergy} subtitle={t.analytics.monthlyEnergySub}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <ChartCard title={t.dashboard.dailySessions} subtitle={t.analytics.dailySessionsSub}>
        ...
        <ChartCard title={t.analytics.availability} subtitle={t.analytics.availabilitySub}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-1">
          <ChartCard title={t.dashboard.statusDistribution} subtitle={t.analytics.statusDistSub}>
        ...
        <div className="lg:col-span-2">
          <ChartCard title={t.analytics.comparison} subtitle={t.analytics.comparisonSub}>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 p-5">
              {statsLoading
                ...
                : [
                    { label: t.analytics.totalChargers, value: stats?.totalChargePoints ?? '—', color: '#3b82f6' },
                    { label: t.dashboard.online, value: stats?.onlineChargePoints ?? '—', color: '#10b981' },
                    { label: t.dashboard.charging, value: stats?.chargingChargePoints ?? '—', color: '#3b82f6' },
                    { label: t.dashboard.offline, value: stats?.offlineChargePoints ?? '—', color: '#f43f5e' },
